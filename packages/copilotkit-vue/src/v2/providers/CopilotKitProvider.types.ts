...
export interface CopilotKitProviderProps {
  ...
  /**
   * FORK ADDITION: direct AG-UI agents registered locally with the provider,
   * merged on top of agents__unsafe_dev_only and selfManagedAgents.
   * This is the supported prop for business code in this project — the key
   * is the agentId referenced by <CopilotChat agent-id="...">.
   */
